...
const updateProductCategories = async (req, res) => {
    try {
        const updateProductCategories = await productCategories.updateOne({_id: req.params.id}, {
            $set: {
                categoryName: req.body.categoryName
            }
        });
...
module.exports = {
    postProductCategories, postProduct, updateProductCategories, updateProduct
